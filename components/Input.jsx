...
const Input = ({id, value, type, label, onChange}) => {
  return (
    <div className='relative'>
      <input className='block rounded-md p-6 pb-1 w-full text-md text-white bg-neutral-700 appearance-none focus:outline-none focus:ring-0 peer' placeholder=' ' id={id} value={value} type={type} onChange={onChange} />
